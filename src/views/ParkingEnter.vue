  ...
  <div class="home">
    ...
    <div class=""> 
      ...
      <div class="modal-content">
          ...
          <h3>Base Fare : Rs 50</h3>
          <div class="sumbitButton fancy-button bg-gradient2" @click="pay"><span><i class="fa fa-envelope"></i>Pay Now</span></div>
      </div> 
    </div>
